    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mt-8 bg-indigo-800 text-white text-center py-6 rounded-lg">
            ...
            <div class="mt-4 space-x-4">
                <button class="bg-white text-indigo-800 py-2 px-4 rounded-full hover:bg-gray-200 transition duration-300">Learn More</button>
                <button class="bg-white text-indigo-800 py-2 px-4 rounded-full hover:bg-gray-200 transition duration-300">Our Products</button>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="text-center">
                    <div class="flex justify-center">
                        <svg class="w-12 h-12 text-[#00aeef]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="bg-white py-8 mt-4">
        <div class="container mx-auto px-4">
            ...
            <div class="mt-6 text-center">
                <!-- <p class="text-sm text-gray-600">We value all feedback. If you’ve faced any issues, like a recent concern about spoiled milk, please reach out to us at <a href="mailto:maziwa@merudairy.co.ke" class="text-indigo-600 hover:underline">maziwa@merudairy.co.ke</a>. We’re committed to ensuring the Cool Mountain Freshness in every sip!</p>
            </div> -->
        </div>
    </section>
    ...
    <section class="bg-indigo-800 py-8 mt-4">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 text-center text-white">
                <!-- Farmers -->
                <div>
                    <svg class="w-12 h-12 mx-auto text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 11a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0015.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.132A8 8 0 008 4.07M3 15.364c.64-1.319 1-2.8 1-4.364 0-1.457.515-2.375.91-2.923a10.416 10.416 0 013.276-2.241 4 4 0 10-5.186 6.528z"></path>
                    </svg>
